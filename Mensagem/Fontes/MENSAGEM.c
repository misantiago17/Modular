/***************************************************************************
*  $MCI Módulo de implementação: MEN  Modulo Mensagem 
*
...
*     9        ms       06/12/2017  edição de descrições ao longo do código
...
MEN_tpCondRet MEN_EscreverMensagem(PER_tpPerfil * Remetente,PER_tpPerfil *Destinatario,char MensagemEnv[]) 
{
    ...
    /* Alocação de memória para o perfil Remetente e Desinatário */
    ...
    /* Verificação da existência do perfil */
    ...
    /* Verifica se o perfil é o mesmo para remetente e destinatário */
...
{ 
    ...
    /* obtem número de mensagens do perfil */
...
{ 
    ...
    /* Obter nœmero de mensagens de um perfil */
...
MEN_tpCondRet MEN_ObterNumMensagens(PER_tpPerfil * Perfil,MEN_tpCondMsg flagMsg, int* numMsgs) 
{
    ...
    /* Verifica se lista de mensagens está vazia  */
